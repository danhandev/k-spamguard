...
**플로우**:
1. 사용자가 "계정 연동" 클릭
2. Meta OAuth 동의 화면 (`instagram_manage_comments`, `instagram_basic` 스코프 요청)
...
| ID | 리스크 | 확률 | 영향 | 완화 전략 |
|---|---|---|---|---|
| R-01 | **Instagram App Review 거절** | 높음 | 치명적 | 개인 계정용 Basic Display API로 MVP 개발 → 앱 심사는 사용자 10명+ 확보 후 신청. 심사 전까지 초대 기반 베타 운영. |
